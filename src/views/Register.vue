...
const icon_class_password = computed(() =>
  isPasswordHidden_password.value ? "fa-eye-slash" : "fa-eye"
);
const type_input_password = computed(() =>
  isPasswordHidden_password.value ? "password" : "text"
);

const icon_class_confirm = computed(() =>
  isPasswordHidden_confirm.value ? "fa-eye-slash" : "fa-eye"
);
const type_input_confirm = computed(() =>
  isPasswordHidden_confirm.value ? "password" : "text"
);

const showPassword = () =>
  (isPasswordHidden_password.value = !isPasswordHidden_password.value);
const showConfirmPassword = () =>
  (isPasswordHidden_confirm.value = !isPasswordHidden_confirm.value);
...
const submitData = async () => {
  ...
  errol.value.CONFIRM_PASSWORD = validateConfirmPassword(
    data_register.value.CONFIRM_PASSWORD,
    data_register.value.PASSWORD
  );
...
<template>
  ...
  <div class="container-fluid row m-0 bg-light bg-gradient mt-5">
    <div
      class="col-lg-3 col-sm-10 col-md-8 m-auto wrap-register border border-1 border-warning rounded-3"
    >
      ...
      <div class="mb-2 row col-lg-10 mx-auto">
        <label
          for="staticEmail"
          class="col-lg-12 mx-auto col-form-label text-white"
          >Địa chỉ email:
        </label>
      ...
      <div class="mb-2 row col-lg-10 mx-auto">
        <div class="col-lg-12 mx-auto">
          <label for="inputPassword" class="col-form-label text-white"
            >Password:
          </label>
          <div class="wrap_password">
            ...
            />
            <i
              class="fa-solid icon_pass"
              :class="icon_class_password"
              @click="showPassword"
            ></i>
          </div>
        </div>
      ...
      <div class="mb-2 row col-lg-10 mx-auto">
        <div class="col-lg-12 mx-auto">
          <label for="confirmPassword" class="col-form-label text-white"
            >Confirm Password:
          </label>
          <div class="wrap_password">
            <input
              :type="type_input_confirm"
              v-model="data_register.CONFIRM_PASSWORD"
              class="form-control py-3"
              id="confirmPassword"
      ...
      <div
        v-if="errol.CONFIRM_PASSWORD"
        class="mb-2 row col-lg-10 mx-auto error"
      >
      ...
      <div class="row col-lg-12 mx-auto mb-5 pb-1">
        <div class="col-lg-10 mx-auto">
          <button
            type="button"
            class="btn btn-primary col-12 d-block mt-4 py-3 mb-3"
            @click="submitData()"
          >
            Sign up
          </button>
